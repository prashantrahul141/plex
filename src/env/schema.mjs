...
export const serverSchema = z.object({
  ...
  G_GITHUB_CLIENT_ID: z.string(),
  G_GITHUB_CLIENT_SECRET: z.string(),

  CLOUDINARY_CLOUDNAME: z.string(),
  CLOUDINARY_CLUODAPIKEY: z.string(),
  CLOUDINARY_CLOUDAPISECRET: z.string(),
});
...
export const serverEnv = {
  ...
  G_GITHUB_CLIENT_ID: process.env.G_GITHUB_CLIENT_ID,
  G_GITHUB_CLIENT_SECRET: process.env.G_GITHUB_CLIENT_SECRET,

  CLOUDINARY_CLOUDNAME: process.env.NEXT_PUBLIC_CLOUDINARY_CLOUDNAME,
  CLOUDINARY_CLUODAPIKEY: process.env.NEXT_PUBLIC_CLOUDINARY_CLOUDAPIKEY,
